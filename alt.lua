Handlers.remove("bet2mint")
Handlers.remove("add_faucet_quota")
Handlers.remove("get-player")
Handlers.remove("ranks")
Handlers.remove("stats")
Handlers.remove("protocols")
Handlers.remove("claim")
Handlers.remove("archive")
Handlers.remove("draw_notice")
Handlers.remove("minting-plus")
...
Name = Name or 'AO-Lotto-Token'
Ticker = Ticker or 'ALT'
Logo = Logo or 'KmN0EfZguGLBPg4z5zz3JfEAgVs6v1MSMKFlqb_wF-I'
...
--
MAX_MINT = MAX_MINT or "210000000000000000000"
...
Handlers.add('mint', {
  ...
  if not TotalSupply then
    TotalSupply = "0"
  end
  -- print(utils.add(Balances[from], quantity))

  Balances[from] = utils.add(Balances[from], quantity)
